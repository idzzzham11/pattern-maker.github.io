  ...
  List<PatternStep> getSleeveSteps(String sleeve) {
    Map<String, List<PatternStep>> sleeveInstructions = {
      ...
      'Puff Sleeve': [
        ...
        PatternStep(
          stepNumber: 3,
          title: 'Langkah 3 - Kemasan dan Cuff',
          instructions: [
            'Buka lipatan pola.',
    ...
    Map<String, List<PatternStep>> skirtInstructions = {
      '12 Gore Graduated Flare': [
        PatternStep(
          ...
          instructions: [
            'Skirt 12 gore dengan kembang bergraduat.',
      ...
      'Full Circle': [
        PatternStep(
          ...
          instructions: [
            ...
            'Ukuran pinggang: ${waist.toStringAsFixed(1)} cm.',
            'Panjang skirt: ${skirtLength.toStringAsFixed(1)} cm.',
            'Jejari dalam = pinggang ÷ 6.28 = ${(waist / 6.28).toStringAsFixed(1)} cm.',
          ],
          diagramType: DiagramType.skirtModification,
        ),
      ],
      ...
      'Skirts With Yoke': [
        PatternStep(
          ...
          title: 'Langkah 1 - Pengubahsuaian',
          instructions: [
            'Skirt dengan yoke di bahagian pinggang.',
            'Ukuran pinggang: ${waist.toStringAsFixed(1)} cm.',
            'Ukuran pinggul: ${hip.toStringAsFixed(1)} cm.',
            'Panjang skirt: ${skirtLength.toStringAsFixed(1)} cm.',
          ],
      ...
      'Tiers': [
        PatternStep(
          ...
          title: 'Langkah 1 - Pengubahsuaian',
          instructions: [
            'Skirt bertingkat dengan beberapa tier.',
            'Ukuran pinggang: ${waist.toStringAsFixed(1)} cm.',
            'Panjang skirt: ${skirtLength.toStringAsFixed(1)} cm.',
          ],
          diagramType: DiagramType.skirtModification,
